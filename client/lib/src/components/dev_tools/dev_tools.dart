...
@Component(
    selector: 'dev-tools',
    templateUrl: 'packages/client/src/components/dev_tools/dev_tools.html',
    useShadowDom: false)
class DevTools {
  static final _logger = new Logger('dev-tools');
  final Window _window;

  DevTools(this._window);

  void deleteDatabase() {
    _logger.finest('resetting db...');
    _window.indexedDB.deleteDatabase('nobs');
